    ...
    <body>
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="nuevo">
                    Producción FTV momentánea: <span class="span" id="potenciaFotovoltaicaLecturaValor"></span><p class="medida">kW</p>
                </div>   
                <div class="nuevo">
                  Producción acumulada hoy: <span class="span" id="hoyFTV"></span><p class="medida">kW</p>
                </div>          
            </div>
            ...
            <div class="card">
                ...
                <div class="nuevo">
                    Producción FTV Total: <span class="span" id="ultimaLecturaFTV"></span><p class="medida">kW</p>
                </div>  
                <div class="nuevo">
           ...
           <!-- Producción FTV Hoy -->
            <div class="card">
                ...
                <div class="co2">
                    Ton/CO2 Evitadas:  <span class="span" id="toneladasValor"></span> 
                </div>
                <div class="co2">
